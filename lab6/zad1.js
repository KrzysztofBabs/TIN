...
var poleP=function poleProstokat(a,b){
    var pole=a*b;
    return pole;
...
var poleT=function poleTrapez(a,b,h){
    var pole=(a+b)*h*0.5;
    return pole;
}

var poleR=function poleRownoleglobok(a,h){
    var pole=a*h;
    return pole;
}

var poleTr=function poleTrojkata(a,h){
    var pole=a*h*0.5;
    return pole;
}

function pole(fn,a,b,h){
    return fn(a,b,h);
